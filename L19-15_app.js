...
// This code only works when DOM is fully rendered. It won't work if loaded from <script> tag inside <head>
// $('img').replaceWith('<img src="http://lorempixel.com/350/150/animals/">');

function swapCuteAnimals() {
    $('img').replaceWith('<img src="http://lorempixel.com/350/150/animals/">');
}
$(swapCuteAnimals)